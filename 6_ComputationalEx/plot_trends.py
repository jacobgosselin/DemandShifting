...
plt.tight_layout()
_save("avg_neg_periods_by_year_slide.pdf")
...
fig.set_size_inches(10, 10)
plt.tight_layout()
_save("cost_ratios_data_vs_model_slide.pdf")
fig.set_size_inches(16, 8)
plt.tight_layout()
...
fig.set_size_inches(10, 10)
plt.tight_layout()
_save("sd_earnings_data_vs_model_slide.pdf")
...
fig.set_size_inches(10, 10)
plt.tight_layout()
_save("sd_sales_data_vs_model_slide.pdf")
fig.set_size_inches(16, 8)
plt.tight_layout()

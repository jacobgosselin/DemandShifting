...
from ss_solver.integrate_dist import (
    pct_negative, pct_negative_profit, est_dist, est_sd,
...
for yr in years:
    ...
    pct_neg_profit_vals.append(pct_negative_profit(m_grid, k_grid, z_grid, eqm))
...
ax2.set_xlabel("Year")
ax2.set_ylabel("")
ax2.set_title("Percent of Firms with Earnings < 0")
...
fig.tight_layout()
_save("phi_and_pct_neg_by_year_slide.pdf", fig, close=False)
...
# Figure B1: Overlay — empirical vs. model avg neg spell/periods by year
plt.figure(figsize=(10, 10))
plt.plot(years, emp_df["avg_neg_spell"], "o-", linewidth=3, markersize=10, label="Data", color=palette_2[0])
plt.plot(years, avg_neg_vals, "s-", linewidth=3, markersize=10, label="Model", color=palette_2[1])
plt.xlabel("Year", fontsize=24)
plt.ylabel("Avg. Length of Negative Earnings Spells (Years)", fontsize=24)
plt.ylim(0, 5)
plt.grid(True, alpha=0.3)
plt.legend(fontsize=24)
_save("avg_neg_periods_by_year_overlay.pdf", close=True)

# Figure C: Two-panel — empirical vs model cost ratios
fig, (ax1, ax2) = plt.subplots(1, 2, figsize=(10, 10))
ax1.plot(years, emp_df["med_cogs_sale"], "o-", linewidth=3, markersize=8, label="COGS/Rev",  color=palette_3[0])
ax1.plot(years, emp_df["med_sga_sale"],  "s-", linewidth=3, markersize=8, label="SG&A/Rev",  color=palette_3[1])
...
ax2.plot(years, med_cogs_all, "o-", linewidth=3, markersize=8, label=f"$W L$/Rev", color=palette_3[0])
ax2.plot(years, med_adv_all,  "s-", linewidth=3, markersize=8, label=f"$W L_a$/Rev",  color=palette_3[1])
ax2.plot(years, med_inv_all,  "^-", linewidth=3, markersize=8, label=f"$W L_k$/Rev",  color=palette_3[2])
ax2.set_xlabel("Year")
ax2.set_ylabel("")
...
# Figure C1: Overlay - empirical vs model med_sga_sale and med_adv_all
plt.figure(figsize=(10, 10))
plt.plot(years, emp_df["med_sga_sale"],  "o-", linewidth=3, markersize=8, label="Data (SG&A/Sales)",  color=palette_2[0])
plt.plot(years, med_adv_all,  "s-", linewidth=3, markersize=8, label=f"Model ($W L_a$/Sales)",  color=palette_2[1])
plt.xlabel("Year", fontsize=24)
plt.ylabel("Median Spending Ratio", fontsize=24)
plt.ylim(0, 0.4)
plt.grid(True, alpha=0.3)
plt.legend(fontsize=24)
_save("sga_sale_vs_adv_overlay.pdf", close=True)


# Figure D: Two-panel overlay — Log std. dev. Sales + Log std. dev. Earnings (Change from 1980)
fig, (ax1, ax2) = plt.subplots(1, 2, figsize=(10, 10))
...
# Figure D1/D2: Overlay - Log sd_sales data vs model and log sd_earnings data vs model
plt.figure(figsize=(10, 10))
plt.plot(years, emp_df["log_sd_sales_norm"],    "o-", linewidth=3, markersize=10, label="Data",    color=palette_2[0])
plt.plot(years, sd_sales_vals,    "s-", linewidth=3, markersize=10, label="Model",    color=palette_2[1])
plt.xlabel("Year", fontsize=24)
plt.ylabel("Std. Dev. (Log Change from 1980)", fontsize=24)
plt.ylim(-0.4, 1.2)
plt.grid(True, alpha=0.3)
plt.legend(fontsize=24)
_save("sd_sales_data_vs_model_overlay.pdf", close=True)
plt.figure(figsize=(10, 10))
plt.plot(years, emp_df["log_sd_earnings_norm"], "o-", linewidth=3, markersize=10, label="Data", color=palette_2[0])
plt.plot(years, sd_earnings_vals, "s-", linewidth=3, markersize=10, label="Model", color=palette_2[1])
plt.xlabel("Year", fontsize=24)
plt.ylabel("Std. Dev. (Log Change from 1980)", fontsize=24)
plt.ylim(-0.4, 1.2)
plt.grid(True, alpha=0.3)
plt.legend(fontsize=24)
_save("sd_earnings_data_vs_model_overlay.pdf", close=True)
...
plt.plot(years, pct_neg_profit_vals, "s-", linewidth=3, markersize=10, label="% Negative Profit", color=palette_2[1])
plt.xlabel("Year", fontsize=18)
plt.ylabel("Percent of Firms (%)", fontsize=18)
plt.legend(fontsize=16)
plt.tick_params(axis="both", which="major", labelsize=16)
plt.grid(True, alpha=0.3)
_save("pct_neg_ebitda_vs_profit_by_year.pdf")
...
axes[1, 0].plot(years, emp_df["log_sd_earnings_norm"], "o-", linewidth=3, markersize=10, label="Earnings", color=palette_2[0])
axes[1, 0].plot(years, emp_df["log_sd_sales_norm"],    "s-", linewidth=3, markersize=10, label="Sales",    color=palette_2[1])
...
axes[1, 1].plot(years, sd_earnings_vals, "o-", linewidth=3, markersize=10, label="Earnings", color=palette_2[0])
axes[1, 1].plot(years, sd_sales_vals,    "s-", linewidth=3, markersize=10, label="Sales",    color=palette_2[1])
...
axes[2, 0].plot(years, emp_df["med_cogs_sale"], "o-", linewidth=3, markersize=8, label="COGS/Rev",  color=palette_3[0])
axes[2, 0].plot(years, emp_df["med_sga_sale"],  "s-", linewidth=3, markersize=8, label="SG&A/Rev",  color=palette_3[1])
...
axes[2, 1].plot(years, med_cogs_all, "o-", linewidth=3, markersize=8, label=f"$W L_i/P_i Y_i$", color=palette_3[0])
axes[2, 1].plot(years, med_adv_all,  "s-", linewidth=3, markersize=8, label=f"$W L_{{a,i}}/P_i Y_i$",  color=palette_3[1])
axes[2, 1].plot(years, med_inv_all,  "^-", linewidth=3, markersize=8, label=f"$W L_{{k,i}}/P_i Y_i$",  color=palette_3[2])
...
plt.plot(range(50), earning_path_1980, "o-", linewidth=5, markersize=8, label="1980", color=palette_2[0])
plt.plot(range(50), earning_path_2019, "s-", linewidth=5, markersize=8, label="2019", color=palette_2[1])
plt.xlabel("Years Since Entry", fontsize=24)
plt.ylabel("Earnings", fontsize=24)
plt.legend(fontsize=24)
plt.grid(True, alpha=0.3)
plt.tight_layout()
_save("avg_earnings_path_1980_vs_2019.pdf", fig, close=False)
fig.set_size_inches(10, 10)
_save("avg_earnings_path_1980_vs_2019_slide.pdf", fig, close=True)
